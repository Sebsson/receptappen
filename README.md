...
- **Veckoplan** – lägg till recept, justera portioner och ta bort. Filtrera planen med sökfält, snabbfilter och de kategorier som finns i planen, och öppna ett recept direkt genom att trycka på dess kort.
